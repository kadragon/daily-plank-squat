...
export function buildHealthPayload(todayRecord: DailyRecord): HealthShortcutPayload {
  return {
    ...
    duration_sec: todayRecord.plank.actual_sec
      ...
      + REP_DURATION_SECONDS * (todayRecord.squat.actual_reps + todayRecord.pushup.actual_reps + todayRecord.dumbbell.actual_reps),
    ...
    dumbbell_actual_reps: todayRecord.dumbbell.actual_reps,
